    ...
    shades: [
      {
        ...
        hsl: '214 69% 97%',
        hex: '#F0F4FD',
        usage: 'fondos sutiles, hover de superficies claras',
      },
      ...
      { shade: 500, hsl: '215 43% 49%', hex: '#4674B8' },
      {
        ...
        hsl: '217 56% 40%',
        hex: '#2B5AA0',
        usage: 'hover del CTA primario',
      },
      {
        shade: 700,
        hsl: '220 73% 33%',
        hex: '#174094',
        usage: 'PRINCIPAL — primary, ring, bordes de marca, títulos H1',
      },
      {
        shade: 800,
        hsl: '214 61% 19%',
        hex: '#132A50',
        usage: 'foreground principal sobre beige',
      },
      {
        shade: 900,
        hsl: '214 63% 15%',
    ...
    shades: [
      {
        ...
        hsl: '36 100% 97%',
        hex: '#FFF9F0',
        usage: 'background global / muted',
      },
      {
        shade: 100,
        hsl: '33 100% 90%',
        hex: '#FFECD2',
        usage: 'PRINCIPAL — secondary, gradiente de la card',
      },
      {
        shade: 200,
        hsl: '51 96% 83%',
        hex: '#FDEEA9',
        usage: 'border / input border por defecto',
      },
  ...
  },
  {
    ...
    shades: [
      ...
      { shade: 400, hsl: '43 91% 69%', hex: '#F7D168' },
      {
        ...
        hsl: '43 89% 61%',
        hex: '#F5C542',
        usage: 'PRINCIPAL — borde back button',
      },
      {
        shade: 600,
        hsl: '39 73% 49%',
        hex: '#DCA223',
        usage: 'icono back button',
      },
      { shade: 700, hsl: '38 72% 43%', hex: '#C18F1E' },
      { shade: 800, hsl: '37 72% 37%', hex: '#A67C19' },
      { shade: 900, hsl: '36 72% 31%', hex: '#8B6914' },
  ...
  },
  {
    ...
    shades: [
      ...
      { shade: 300, hsl: '177 72% 57%', hex: '#40D9D0' },
      {
        ...
        hsl: '177 100% 42%',
        hex: '#00C7BC',
        usage: 'focus border de inputs',
      },
      {
        shade: 500,
        hsl: '177 100% 36%',
        hex: '#00B8A9',
        usage: 'PRINCIPAL — accent, iconos activos',
      },
      {
        shade: 600,
        hsl: '177 100% 30%',
        hex: '#009A8E',
        usage: 'texto confirmación (ej: ciudad encontrada)',
      },
  ...
  },
  {
    ...
    shades: [
      ...
      { shade: 300, hsl: '5 100% 72%', hex: '#FF8570' },
      {
        ...
        hsl: '7 100% 65%',
        hex: '#FF664D',
        usage: 'PRINCIPAL — destructive (errores, no encontrado)',
      },
      {
        shade: 500,
        hsl: '13 100% 48%',
        hex: '#F73200',
        usage: 'destructive en dark mode',
      },
...
export const semanticTokens: SemanticToken[] = [
  {
    name: 'background',
    mapsTo: 'km0-beige-50',
    description: 'Fondo global de la app.',
  },
  {
    name: 'foreground',
    mapsTo: 'km0-blue-800',
    description: 'Color de texto por defecto sobre background.',
  },
  {
    name: 'card',
    mapsTo: 'white',
    description: 'Superficie de tarjetas (inputs, popovers).',
  },
  {
    name: 'primary',
    mapsTo: 'km0-blue-700',
    description: 'CTA principal, foco, énfasis máximo.',
  ...
  {
    name: 'secondary',
    mapsTo: 'km0-beige-100',
    description: 'Superficies cálidas secundarias.',
  },
  {
    name: 'muted',
    mapsTo: 'km0-beige-50',
    description: 'Fondos sutiles, separadores blandos.',
  },
  {
    name: 'muted-foreground',
    mapsTo: 'hsl(220 9% 46%)',
    description: 'Texto secundario / placeholder visible.',
  },
  {
    name: 'accent',
    mapsTo: 'km0-teal-500',
    description: 'Acento interactivo (iconos, hovers de elementos teal).',
  },
  {
    name: 'destructive',
    mapsTo: 'km0-coral-400',
    description: 'Errores, validación negativa, acciones destructivas.',
  },
  {
  ...
  {
    name: 'border',
    mapsTo: 'km0-beige-200',
    description: 'Bordes neutros por defecto.',
  },
  {
    name: 'input',
    mapsTo: 'km0-beige-200',
    description: 'Borde de campos de formulario.',
  },
  {
    name: 'ring',
    mapsTo: 'km0-blue-700',
    description: 'Anillo de focus accesible.',
  },
  {
    name: 'radius',
    mapsTo: '0.75rem',
    description: 'Radio base; rounded-2xl/3xl son los más usados.',
  },
]
...
export const typography: TypographyEntry[] = [
  {
    ...
    weight: 900,
    usage:
      'Títulos H1 de pantalla, branding (logo). NUNCA añadir font-bold encima.',
  ...
  },
  {
    ...
    weight: 400,
    usage:
      'Texto de UI: labels, botones, inputs. Permite font-semibold/medium.',
    sample: 'CONTINUAR',
  },
  {
    className: 'font-body',
...
export const typeScale = [
  {
    ...
    px: 12,
    lineHeight: 16,
    usage: 'captions, errores en landscape',
  },
  {
    className: 'text-sm',
    px: 14,
    lineHeight: 20,
    usage: 'subtítulos, copy de soporte, CTAs',
  },
  ...
  { className: 'text-lg', px: 18, lineHeight: 28, usage: 'input grande' },
  {
    ...
    px: 20,
    lineHeight: 28,
    usage: 'H1 confirmación (ciudad)',
  },
  {
    className: 'text-2xl',
    px: 24,
    lineHeight: 32,
    usage: 'H1 principal en portrait',
  },
  {
    className: 'text-3xl',
    px: 30,
    lineHeight: 36,
    usage: 'H1 grande en horizontal-desktop',
  },
]
...
export const radiusScale = [
  ...
  { className: 'rounded-xl', px: 12, usage: 'back button' },
  {
    ...
    px: 16,
    usage: 'PRINCIPAL — inputs, botones, cards internas',
  },
  {
    className: 'rounded-3xl',
    px: 24,
    usage: 'BrandedFrame outer card, imágenes hero',
  },
]
...
export const animations = [
  {
    ...
    duration: '0.4s',
    easing: 'ease-out',
    usage: 'entrada de elementos al montar',
  },
  {
    name: 'float',
    ...
    usage: 'mascota / elementos ambientales',
  },
  {
    name: 'framer fade+y',
    ...
    duration: '0.4s',
    easing: 'default',
    usage: 'stagger 0.15s entre bloques en pantallas con marca',
  },
]
  ...
  semanticPairs: [
    {
      positive: 'MapPin',
      negative: 'MapPinOff',
      context: 'ubicación válida vs no reconocida',
    },
    {
      positive: 'Check',
