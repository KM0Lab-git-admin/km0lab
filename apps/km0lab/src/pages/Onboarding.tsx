              ...
              {slides.map((s, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className={`bg-white rounded-3xl overflow-hidden ${isActive ? 'shadow-2xl' : 'shadow-none'}`}
                    >
                      {/* Image area */}
                      <div
                      ...
                      >
                        <span className="text-[70px] select-none">
                          {s.emoji}
                        </span>
                        {isActive && (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ background: s.color }}
                    >
                      <span className="text-[80px] wide-landscape:text-[120px] short-landscape:text-[clamp(52px,10vh,96px)] select-none">
                        {s.emoji}
                      </span>
                      {isActive && (
